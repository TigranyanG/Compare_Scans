...
input_file = os.path.join('02_Incoming_Scans', 'nessus_scan_sample.csv')
output_file = os.path.join('04_Processing', 'processed_nessus.xlsx')
...
print(f"Processed {len(aggregated)} vulnerabilities.")